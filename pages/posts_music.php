...
if($_SESSION["USER_ID"])
{
  ...
  if($count > 2)
  {
    ...
    { 
      ...
      {
        if($file_info["FILE_TYPE"] == "audio/mp3")
        {
          ...
          if($file_info["FILE_TYPE"] == "audio/mp3") echo "<div class='imgpost'><audio src='".$pInfo["F_DIR:ORIGINAL"].$file_info["FILE_PATH"]."' controls preload class='image'></audio></div>";
          echo "  
