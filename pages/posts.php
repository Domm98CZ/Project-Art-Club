  ...
  if($count > 2)
  {
    ...
    { 
      if($file_info["FILE_SHOW"] == "1")
      {
        ...
        else if($file_info["FILE_TYPE"] == "audio/mp3") echo "<div class='imgpost'><audio src='".$pInfo["F_DIR:ORIGINAL"].$file_info["FILE_PATH"]."' controls preload class='image'></audio></div>";
        else if($file_info["FILE_TYPE"] == "video/mp4") echo "<div class='imgpost'><video src='".$pInfo["F_DIR:ORIGINAL"].$file_info["FILE_PATH"]."' width='320' height='200' controls preload class='image'></video></div>";
        else if($file_info["FILE_TYPE"] == "video/youtube") echo "<div class='imgpost'><iframe class='image' width='320' height='200' src='//www.youtube.com/embed/".$file_info["FILE_PATH"]."' frameborder='0' allowfullscreen></iframe></div>"; 
        echo "
